...
function timeStepDelta(t0, timeStep, timeStepSize) {
	...
	switch(timeStep) {
		case 'second':
	        t1.setTime(t0.getTime() + units*1000);
	        t2.setTime(t0.getTime() + units*1000*1.25); break;
	    case 'minute':
	        t1.setTime(t0.getTime() + units*60000);
	        t2.setTime(t0.getTime() + units*60000*1.25); break;
	    case 'hourly':
	        t1.setTime(t0.getTime() + units*3600000);
	        t2.setTime(t0.getTime() + units*3600000*1.25); break;
	    case 'daily':
